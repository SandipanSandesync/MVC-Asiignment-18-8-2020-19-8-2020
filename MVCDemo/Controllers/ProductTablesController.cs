...
namespace MVCDemo.Controllers
{
    ...
    {
        private JulDotNetBatchEntities db = new JulDotNetBatchEntities();
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,ProductPrice")] ProductTable productTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,ProductPrice")] ProductTable productTable)
        {
            if (ModelState.IsValid)
            {
